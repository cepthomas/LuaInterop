...
M.script_funcs =
{
...

    {
        ...
        args =
        {
            { name = "arg_one", type = "B", description = "aaa bbb ccc" },
        },
...

    {
        ...
        ret = { type = "I", description = "Dummy return value." }
    },
}
...
M.host_funcs =
{
...

    {
        ...
        args =
        {
            { name = "tzone", type = "I", description = "Time zone" },
        },
        ret = { type = "S", description = "The time" }
    }
}
